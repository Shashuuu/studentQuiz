...
<head>
    <title>
        Multiplication Quiz Answers
    </title>
</head>
<body>
<h1>Multiplication Quiz ANSWERS</h1><br>

<%--table to display the results for the multiplication quiz taken in multiplication.jsp page.--%>
<table>
    <% int correctCount = 0;
        for (int i = 0; i < 10; i++){
